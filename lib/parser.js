...
class ProductParser {
    constructor() {
        this.platformSelectors = {
            ...
            aliexpress: {
                ...
                description: ['[class*="product-description"]', '[class*="detail-desc"]'],
    ...
    async extractProductData(url = window.location.href) {
        ...
        const specs = this.extractSpecifications(platform);
    ...
    async extractDetailedDescription(platform) {
        ...
        try {
            ...
            if (platform === 'aliexpress') {
                descEl = document.querySelector('#product-description, .product-description, [data-widget="productDescription"]');
            }
